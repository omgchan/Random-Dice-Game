...
1. **Select a number (1–6)** from the options.
2. **Click the dice** to roll.
3. If your guess matches the dice roll → ✅ **you earn points equal to your guess**.  
   If not → ❌ **you lose 2 points**.
4. Click **Reset Score** to start over.
5. Toggle **Show Rules** anytime to revisit instructions.
